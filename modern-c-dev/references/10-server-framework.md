# Source: https://hackmd.io/s/B1s8hX1yg

# server-framework
contributed by <`LanKuDot`>, <`ktvexe`>,<`judy66jo`>, <`JonSyuGithub`>
==[直播錄影](https://www.youtube.com/watch?v=0baR1Ly6zD8&feature=youtu.be)==
...
* 強化 Concurrecny
* 整合 [cgi-server + facebooc](https://paper.dropbox.com/doc/MT7688-cgi-server-facebooc-rIidaB3mH06v0rmP1iwL1)，設計更好的物件導向封裝
