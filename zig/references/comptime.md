...
| `@Int`, `@Enum`, `@Struct`, `@Union`, `@Pointer`, `@Fn`, `@Tuple`, `@EnumLiteral` | Create type from type info (replaced `@Type` in 0.16.0) |
...
| Generate types | Yes | Return struct from function, use `@Int`/`@Struct`/`@Union`/etc. |
